        ...
        <form onSubmit={onSubmit}>
          <div className="mb-3">
            ...
            <input
              ...
              className={`backdrop-container form-control ${errors.username ? "is-invalid" : ""}`}
            />
            {errors.username && (
          ...
          <div className="mb-3">
            ...
            <input
              ...
              type="email"
              autoComplete="email"
              className={`backdrop-container form-control ${errors.email ? "is-invalid" : ""}`}
            />
            {errors.email && (
          ...
          <div className="mb-3">
            ...
            <input
              ...
              className={`backdrop-container form-control ${errors.password ? "is-invalid" : ""}`}
            />
            {errors.password && (
